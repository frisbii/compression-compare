...
size_t lz4_wrapper_compress(word* src, word* dst, size_t buffer_size, int clevel) {
    if (clevel == 0) {
        ...
        // acceleration level is the dial in lz4
        int acclevel_lz4;
        switch (clevel) {
            case 9: acclevel_lz4 = 0; break;
            case 8: acclevel_lz4 = 8191; break;
            case 7: acclevel_lz4 = 16383; break;
            case 6: acclevel_lz4 = 24575; break;
            case 5: acclevel_lz4 = 32767; break;
            case 4: acclevel_lz4 = 40959; break;
            case 3: acclevel_lz4 = 49151; break;
            case 2: acclevel_lz4 = 57343; break;
            case 1: acclevel_lz4 = 65535; break;
        }
    
        compressed_size = LZ4_compress_fast((char*) src, (char*) dst, BYTES_PER_PAGE, buffer_size, acclevel_lz4);
    }
